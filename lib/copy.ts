...
export const TREATMENTS = [
  ...
  },
  {
    ...
    d: '미세현미경으로 근관을 정밀하게. 자연치아 최대 보존이 원칙입니다.',
    summary: '살릴 수 있는 치아는 끝까지 살립니다.',
    intro: '신경치료는 충치가 깊어 치수(신경)까지 감염된 경우, 감염된 조직을 제거하고 근관을 소독·밀폐하여 자연치아를 보존하는 치료입니다. 치과보존과 전문의가 미세현미경으로 근관 하나하나를 정밀하게 처치합니다.',
    processes: [
      '증상 문진 및 방사선 검사',
      '마취 후 감염 치수 제거',
      '근관 형성 및 세척·소독',
...
export const EQUIPMENTS = [
  {
    n: '3D CT · 구강 스캐너',
    d: '본 뜨는 불편함 없이 3D 스캔으로 정밀한 데이터를 확보합니다.',
    bg: V.equip,
    brand: 'Vatech',
    features: [
      '저선량 파노라마 · 세팔로 · 3D CT 촬영 지원',
      '신경관 · 뼈 두께 · 매복 사랑니 위치 정밀 분석',
      '구강 스캐너로 본뜨기 없이 디지털 인상 채득',
      '임플란트 가이드 수술 데이터로 활용',
    ],
    uses: '임플란트 · 사랑니 발치 · 턱관절 진단 · 교정 전 정밀 진단',
  },
  {
    n: 'CAD/CAM CEREC',
    d: '디지털 설계와 밀링으로 당일 보철물 제작이 가능합니다.',
    bg: V.scan,
    brand: 'Dentsply Sirona',
    features: [
      '원데이 세라믹 보철 — 본뜨기 없이 당일 완성',
      '3D 디지털 설계로 정교한 교합 재현',
      '세라믹 블록 밀링으로 내구성과 심미성 확보',
      '추가 내원 없이 임시 보철 과정 생략',
    ],
    uses: '크라운 · 인레이 · 온레이 · 베니어 · 원데이 임플란트 보철',
  },
  {
    n: '디지털 엑스레이',
    d: '낮은 방사선량의 선명한 영상으로 정확한 진단을 돕습니다.',
    bg: V.clinic,
    brand: 'Digital DR',
    features: [
      '기존 필름 대비 약 1/10 수준의 저선량',
      '촬영 즉시 모니터 확인 가능',
      '고해상도로 미세 충치 · 치근단 병변 조기 발견',
      '현상 약품 불사용 — 환경 친화적',
    ],
    uses: '기본 진단 · 충치 검사 · 치료 경과 확인',
  },
  {
    n: '미세 현미경',
    d: '20배 이상 확대로 미세한 치아 구조까지 정밀하게 확인합니다.',
    bg: V.gen,
    brand: 'Operation Microscope',
    features: [
      '최대 20배 이상 광학 확대',
      '육안으로 보이지 않는 근관과 균열 확인',
      'LED 조명으로 시야 확보, 재치료율 감소',
      '치과보존과 전문의의 정밀 근관 치료에 필수',
    ],
    uses: '신경치료 · 재근관치료 · 미세 수복 · 크랙 탐색',
  },
];
